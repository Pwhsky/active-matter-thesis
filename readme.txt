...
The program takes in 5 arguments as of now, you must specify them or the program will not run.
  ...
  $ python3 temperature.py resolution nDeposits newData bounds periodicity

  resolution  (integer): Specifies the number of points per axis in the simulation, 300 is ideal.
...
Examples (be in janus-gradient directory):
  ...
  $ python3 gradient_quiver.py 300 600 true 3 80000
  $ python3 temperature.py 300 2000 true 4 80000
  $ python3 gradient.py 300 600 false 3 80000
