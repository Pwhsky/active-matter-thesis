...
def generateFigure(imageBounds):
	...
	wedge1  = Wedge((particle_1.iloc[-1]['x'], particle_1.iloc[-1]['z']), 2e-6, 0, 180, color='blue', alpha=0.6)
	circle1.set(fill=False, alpha=0.5)

	circle2 = Circle((particle_2.iloc[-1]['x'], particle_2.iloc[-1]['z']), 2e-6)
	wedge2  = Wedge((particle_2.iloc[-1]['x'], particle_2.iloc[-1]['z']), 2e-6, 0, 180, color='blue', alpha=0.6)
